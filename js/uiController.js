...
//       text: optionText, // Using textContent instead of innerHTML to prevent HTML injection
//     })
...
//   // Import and store the result data for stats navigation
//   import("./stats.js").then((module) => {
//     module.setLastResultData(resultData)
//   })
...
//   const scorePercentage = createEl("div", {
//     className: "score-percentage",
//     text: `${percentage}%`,
//   })

//   const scoreFraction = createEl("div", {
...
//   const timeTaken = createEl("div", {
//     className: "time-taken",
//     text: `⏱️ Temps: ${formatSeconds(elapsedMs)}`,
//   })

//   const accuracy = createEl("div", {
//     className: "accuracy",
//     text: `🎯 Précision: ${percentage}%`,
//   })
...
// // Creates individual question correction card - FIXED to use textContent
...
//   const questionNumber = createEl("span", {
//     className: "question-number",
//     text: `Question ${questionIndex + 1}`,
//   })

//   const statusBadge = createEl("span", {
//     className: `status-badge ${isCorrect ? "correct" : "incorrect"}`,
...
//   // Create question text - SAFE textContent usage
//   const questionText = createEl("div", {
...
//     text: "Votre réponse:",
//   })
//   const userAnswerSpan = createEl("span", {
//     className: `user-answer ${isCorrect ? "correct" : "incorrect"}`,
//     text: userAnswers, // SAFE textContent usage
//   })
...
//   // Correct answer row (only if incorrect)
//   if (!isCorrect) {
//     const correctAnswerRow = createEl("div", { className: "answer-row" })
//     const correctLabel = createEl("span", {
//       className: "answer-label",
//       text: "Réponse correcte:",
//     })
//     const correctAnswerSpan = createEl("span", {
//       className: "correct-answer",
//       text: correctAnswers, // SAFE textContent usage
//     })
...
// // Helper function to get user's answers as text - SAFE implementation
...
//         ? question.options[idx] // This is now safe as textContent will be used
//         : "Réponse invalide"
//     })
//     .join(", ")
// }

// // Helper function to get correct answers as text - SAFE implementation
...
//   return (
//     userIndices.every((idx) => correctIndices.includes(idx)) && correctIndices.every((idx) => userIndices.includes(idx))
//   )
// }
...
//   selectedIndices = (Array.isArray(selectedIndices) ? selectedIndices.map(Number) : []).slice()
//   correctIndices = (Array.isArray(correctIndices) ? correctIndices.map(Number) : []).slice()
...
//   } else {
//     const correctCount = selectedIndices.filter((i) => correctIndices.includes(i)).length
...
// }
// uiController.js
// UI rendering helpers for the quiz (questions, timer, results, theme selection).
import { createEl, formatSeconds } from "./utils.js";
